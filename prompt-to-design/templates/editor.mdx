---
title: "Editor"
description: "Editor-style interfaces and content layouts."
---


<img
  src="/images/templates/editor-1.png"
  alt="editor template 1"
  width={850}
...
<img
  src="/images/templates/editor-2.png"
  alt="editor template 2"
  width={850}
  className="rounded-xl shadow-lg"
  style={{ marginBottom: '32px' }}
/>
...
<img
  src="/images/templates/editor-3.png"
  alt="editor template 3"
  width={850}
  className="rounded-xl shadow-lg"
  style={{ marginBottom: '32px' }}
/>
