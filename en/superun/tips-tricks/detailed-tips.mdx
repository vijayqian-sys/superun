...
<Card title="superun Storage Guide" icon="database" href="/en/superun/integrations/storage" horizontal>
...
<Card title="Resend Integration Guide" icon="envelope" href="/en/superun/integrations/resend" horizontal>
...
<Card title="Configure SMTP with Personal 163 Email" icon="envelope" href="/en/superun/tips-tricks/configure-163-smtp" horizontal>
...
<Card title="Speech Engine Integration Guide" icon="microphone" href="/en/superun/tips-tricks/speech-engines" horizontal>
